...
// Opioid Coin (OID) 2018 visit https://oid.life
// Code of conduct -> https://github.com/OidLife/Conduct

#include "alert.h"
#include "checkpoints.h" //checkpoints is standard TBD
#include "db.h"
#include "txdb.h"
#include "net.h"
#include "init.h"
...
#if defined(NDEBUG)
# error "Opioid cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x0bc4c963896fc64479486847f45d7adf8ec1bb75e58ad079ed356a6f55942b4d");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Opioid: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Opioid Signed Message:\n";
...
{
    // Opioid: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Opioid: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Opioid: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1523483731, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "The times reported that chad broke his nose";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 500 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("049fdf489a2702a21b71ebd5be68812a16d23b1a2c1bbb45eb2125fa18b197ec3a511cd887e0390a5ad2ecce116791826f97757d06996cf3f626ace46c82af4d3c") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1523483731;
        ...
        assert(block.hashMerkleRoot == uint256("0x2af90a054f90110ac88bc21a19bf96b1dac3ad53bd858f09d2946221e670899b"));
...
unsigned char pchMessageStart[4] = { 0x1d, 0x4b, 0x0f, 0xbc }; // Opioid: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("OpioidMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("OpioidMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static OpioidMiner(CWallet *pwallet)
{
    printf("OpioidMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("opioid-miner");
    ...
    try { loop {
        ...
        printf("Running OpioidMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&OpioidMiner, pwallet));
}
